/* Nihonggo Pro Academy v2.0 - 2026-06-23 */
(function () {
'use strict';
...
<img src="/assets/logo-neko.svg" alt="Nihonggo Pro Academy" style="height:42px;width:42px;border-radius:50%;object-fit:cover;border:2px solid rgba(200,160,0,.4)" onerror="this.style.display='none'">
<span class="kn-logo-jp" style="font-size:.95rem;letter-spacing:.02em">Nihonggo Pro</span>
<span class="kn-logo-sep" aria-hidden="true"></span>
<span class="kn-logo-tag" style="font-size:.72rem;color:#e53935;font-weight:700;letter-spacing:.1em">ACADEMY</span>
</a>
<!-- CENTER LINKS -->
...
${di('ℹ️','Tentang Kami','Kenalan dengan NihonggoPro','/About.html')}
...
<a href="/index.html" class="kn-drawer-logo">Nihonggo Pro Academy</a>
